                ...
                <div class="card-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                        $n = 0;
                        $data = mysqli_fetch_all($conn->query("SELECT d.*, b.branch as bb FROM `withdraw` as d inner join `branch` as b on (d.branch = '$_SESSION[branch]' AND d.branch = b.id) ORDER BY d.id DESC"), MYSQLI_ASSOC);
                        foreach($data as $row){
                      ?>
                      <tr>
                        <td><?php echo ++$n; ?></td>
